// A2A Client for invoking Azure AI Foundry Agent Host (New Responses API version)
...
string serverUrl = configuration["A2A_SERVER_URL"] ?? "http://localhost:57697";

Console.WriteLine("╔══════════════════════════════════════════════════════════╗");
Console.WriteLine("║   A2A Foundry Client - Responses API (New SDK)           ║");
Console.WriteLine("╚══════════════════════════════════════════════════════════╝");
Console.WriteLine();
